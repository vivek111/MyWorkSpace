...
def Morning():
    ...
    names = {1: "Coffee", 2: "Tea", 3: "Cooldrinks", 4: "Idli", 5: "MasalaDosa", 6: "SetDosa", 7: "Vada", 8: "Palav",
             9: "Bisibelebath"}
    amount = 0
    list1 = list()
    pair = {"Coffee": 0, "Tea": 0, "Cooldrinks": 0, "Idli": 0, "MasalaDosa": 0, "SetDosa": 0, "Vada": 0, "Palav": 0,
            "Bisibelebath": 0}
...
def bill(list1, pair):
    ...
    slno = slno + 1
    import time
    amount = {"Coffee": 20, "Tea": 15, "Cooldrinks": 20, "Idli": 30, "MasalaDosa": 40, "SetDosa": 35, "Vada": 20,
              "Palav": 40, "Bisibelebath": 35
        , "South Indian Meal": 65, "North Indian Meal": 105, "Sevpuri": 25, "Bhelpuri": 30, "Masalapuri": 30,
              "Panipuri": 25}
